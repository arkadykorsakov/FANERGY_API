...
class PostController extends Controller
{
	...
	public function updateSubscriptionLevel(Post $post, UpdateSubscriptionLevel $request): \Illuminate\Http\JsonResponse
	{
		Gate::authorize('update-post', $post);
		$post = $this->postService->updateSubscriptionLevelForPost($post, $request);
		return response()->json(['post' => PostResource::make($post)]);
	}
